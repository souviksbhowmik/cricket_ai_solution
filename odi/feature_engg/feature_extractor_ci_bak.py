...
def get_batsman_score_features(player_list_df,ref_date=None,batsman_count=7):
    ...
    player_list_df['log_factor_mid_order'] = 11-np.abs(4-player_list_df['position'])
    # player_list_df.fillna(1,inplace=True)
    player_list_df['log_scale'] = np.log(player_list_df['log_factor'])
    player_list_df['log_scale_mid_order'] = np.log(player_list_df['log_factor_mid_order'])
    player_list_df['score_weighted_log'] = player_list_df['batsman_score'] * player_list_df['log_scale']
    player_list_df['score_weighted_log_mid_order'] = player_list_df['batsman_score'] * player_list_df['log_scale_mid_order']
    ...
    score_sum_weighted_by_log_mid_order = player_list_df.head(batsman_count)['score_weighted_log_mid_order'].sum()
    ...
    score_mean_weighted_by_log = player_list_df.head(batsman_count)['score_weighted_log'].sum() / player_list_df.head(7)['log_scale'].sum()
    score_mean_weighted_by_log_mid_order = player_list_df.head(batsman_count)['score_weighted_log_mid_order'].sum() / \
                                 player_list_df.head(7)['log_scale_mid_order'].sum()
    ...
    entry = {
        ...
        "score_sum_weighted_by_log_mid_order":score_sum_weighted_by_log_mid_order,
        ...
        "score_mean_weighted_by_log_mid_order":score_mean_weighted_by_log_mid_order,
