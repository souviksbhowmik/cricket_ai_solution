from odi.data_loader import download_controller as dc
import os
...
def load_current(from_date, to_date,append):
    ...
    downloaded_file_dir = dc.download_zip('https://cricsheet.org/downloads/odis.zip')
    print('New zip downloaded')
